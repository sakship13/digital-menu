       ...
       <section className="section about text-center" aria-labelledby="about-label" id="about">
        <div className="container">
          ...
          <figure className="about-banner">
            ...
            <img src={`${process.env.PUBLIC_URL}/images/about-banner.jpg`} width="570" height="570" loading="lazy" alt="about banner"
            ...
            <div className="abs-img abs-img-1 has-before" data-parallax-item data-parallax-speed="1.75">
              <img src={`${process.env.PUBLIC_URL}/images/about-abs-image.jpg`} width="285" height="285" loading="lazy" alt=""
                className="w-100"/>
            </div>
          ...
          <img src={`${process.env.PUBLIC_URL}/images/shape-3.png`} width="197" height="194" loading="lazy" alt="" className="shape"/>
